#!/bin/bash
# ------------------------------------------------------------------
# Script to call MediaMTX_AddPath via TakatVideo API (with login)
# ------------------------------------------------------------------
...
ADD_PATH_ENDPOINT="/api/persistantvideo/MediaMTX/AddPath"
...
# ------------------------------------------------------------
# 2. Prompt for AddPath parameters
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 4. Send AddPath request
# ------------------------------------------------------------
echo "Sending AddPath request to MediaMTX..."
