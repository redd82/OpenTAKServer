...
group_api = Blueprint("takat_group_api", __name__)
...
def remove_user_from_group():
    ...
    logger.info("remove_user_from_group request args: username=%s, group_name=%s, direction=%s", username, group_name, direction)
