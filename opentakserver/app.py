...
def create_app(cli=True):
    ...
    if not cli:
        ...
        from opentakserver.blueprints.TakatVideo_api import TakatVideo_blueprint
        app.register_blueprint(TakatVideo_blueprint)

        from opentakserver.blueprints.TakatPersistantVideo_api import takat_persistant_video_api_extensions
        app.register_blueprint(takat_persistant_video_api_extensions)
